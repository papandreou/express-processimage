                ...
                create: function () {
                    ...
                    if (sourceContentType === 'image/gif' && !this.operations.some(function (operation) {
                        ...
                        if (filters.gifsicle !== false && Gifsicle && this.operations.every(function (operation) {
                            return operation.name === 'resize' || operation.name === 'extract' || operation.name === 'rotate' || operation.name === 'withoutEnlargement' || operation.name === 'progressive' || operation.name === 'crop';
                        })) {
                            engineName = 'gifsicle';
                        }
                    }
                    ...
                    if (engineName === 'gifsicle') {
                        ...
                        return new Gifsicle(gifsicleArgs);
