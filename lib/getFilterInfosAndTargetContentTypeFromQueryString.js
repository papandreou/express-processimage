                ...
                filterInfos.push({
                    ...
                    create: function () {
                        ...
                        return sharpOperationsForThisInstance.reduce(function (sharpInstance, operation) {
                            ...
                            // Waiting for https://github.com/lovell/sharp/pull/255
                            if (operation.name === 'crop' && typeof operation.args[0] === 'string') {
                                operation.args[0] = sharp.gravity[operation.args[0]];
                            }
