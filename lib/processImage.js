var getFiltersAndTargetContentTypeFromQueryString = require('./getFiltersAndTargetContentTypeFromQueryString');
        ...
        if (matchQueryString && req.accepts('image/*')) {
            ...
            res.hijack(function (err, res) {
                ...
                if (contentType && contentType.indexOf('image/') === 0) {
                    var filtersAndTargetFormat = getFiltersAndTargetContentTypeFromQueryString(queryString),
