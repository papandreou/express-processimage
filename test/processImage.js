...
describe('express-processimage', () => {
  ...
  const expect = unexpected
    ...
    .addAssertion('<string|object> to yield response <object|number>', (expect, subject, value) => expect(
    express()
    ...
    .addAssertion('<Buffer> [when] converted to PNG <assertion>', (expect, subject) => {
  ...
  it('should not mess with request for non-image file', () => expect('GET /something.txt', 'to yield response', {
    headers: {
  ...
  it('should not mess with request for image with no query string', () => expect('GET /ancillaryChunks.png', 'to yield response', {
    headers: {
  ...
  it('should not mess with request for image with an unsupported operation in the query string', () => expect('GET /ancillaryChunks.png?foo=bar', 'to yield response', {
    headers: {
      'Content-Type': 'image/png'
    },
    body: expect.it('to have length', 3711)
  ...
  describe('with the sharp engine', () => {
    it('should resize by specifying a bounding box', () => expect('GET /turtle.jpg?resize=500,1000', 'to yield response', {
    ...
    describe('when omitting the height', () => {
      it('should do a proportional resize to the given width', () => expect('GET /turtle.jpg?resize=500,', 'to yield response', {
        body: expect.it('to have metadata satisfying', {
          size: {
            width: 500,
            height: 441
    ...
    describe('when omitting the width', () => {
      it('should do a proportional resize to the given height', () => expect('GET /turtle.jpg?resize=,500', 'to yield response', {
        body: expect.it('to have metadata satisfying', {
          size: {
            width: 567,
            height: 500
    ...
    it('should do an entropy-based crop', () => expect(
    ...
    it('should do an attention-based crop', () => expect(
  ...
  describe('with the sharp engine', () => {
    it('should resize by specifying a bounding box', () => expect(
  ...
  it('should run the image through pngcrush when the pngcrush CGI param is specified', () => expect(
  ...
  it('should run the image through pngquant when the pngquant CGI param is specified', () => expect('GET /purplealpha24bit.png?pngquant', 'to yield response', {
    statusCode: 200,
    headers: {
      'Content-Type': 'image/png'
    },
  ...
  it('should run the image through jpegtran when the jpegtran CGI param is specified', () => expect(
  ...
  it('should run the image through graphicsmagick when methods exposed by the gm module are added as CGI params', () => expect('GET /turtle.jpg?gm&resize=340,300', 'to yield response', {
    statusCode: 200,
    headers: {
      'Content-Type': 'image/jpeg'
    },
  ...
  it('should run the image through sharp when methods exposed by the sharp module are added as CGI params', () => expect(
  ...
  it('should run the image through svgfilter when the svgfilter parameter is specified', () => expect(
  ...
  it('should run the image through multiple filters when multiple CGI params are specified', () => expect(
  ...
  it('should serve a converted image with the correct Content-Type', () => expect(
  ...
  it('should serve an error response if an invalid image is processed with GraphicsMagick', () => expect('GET /invalidImage.png?setFormat=jpg', 'to yield response', {
    errorPassedToNext: true
  }));

  it('should serve an error response if an invalid image is processed with pngquant', () => expect('GET /invalidImage.png?pngquant', 'to yield response', {
    errorPassedToNext: true
  }));

  it('should include the command line in the response body when an error is encountered', () => // TODO: This test results in a statusCode 404. That is weird...
  ...
  it('should convert an icon to png via GraphicsMagick', () => expect('GET /favicon.ico?gm&png', 'to yield response', {
    headers: {
      'Content-Type': 'image/png'
    },
    body: expect.it('to have metadata satisfying', {
  ...
  it('should convert an icon served as image/vnd.microsoft.icon to png via GraphicsMagick', () => expect(
    express()
      .use(processImage(config))
  ...
  describe('with an allowOperation option', () => {
    ...
    it('should allow an operation for which allowOperation returns true', () => expect('GET /turtle.jpg?resize=87,100', 'to yield response', {
      headers: {
        'Content-Type': 'image/jpeg'
      },
    ...
    it('should disallow an operation for which allowOperation returns false', () => expect('GET /turtle.jpg?png', 'to yield response', {
      headers: {
        'Content-Type': 'image/jpeg'
      },
      body: expect.it('to have metadata satisfying', {
  ...
  describe('with the sharp engine', () => {
    ...
    it.skip('should process and convert a transparent gif', () => expect('GET /transparentbw.gif?flip&png', 'to yield response', {
      body: expect.it('to have metadata satisfying', {
        format: 'PNG'
      })
    }));
    ...
    it('should allow retrieving the image metadata as JSON and support conditional GET', () => expect('GET /turtle.jpg?metadata', 'to yield response', {
      headers: {
    ...
    it('should allow retrieving the metadata of a non-image file with a non-image extension', () => expect('GET /something.txt?metadata', 'to yield response', {
      body: {
    ...
    it('should set animated:true for an animated gif', () => expect('GET /animated.gif?metadata', 'to yield response', {
      body: {
        animated: true
      }
    }));

    it('should set animated:false for a non-animated gif', () => expect('GET /bulb.gif?metadata', 'to yield response', {
      body: {
        animated: false
      }
    }));

    it('should allow support ?metadata=true as well (legacy)', () => expect('GET /turtle.jpg?metadata=true', 'to yield response', {
      body: {
        contentType: 'image/jpeg',
        filesize: 105836,
        etag: /^W\//,
    ...
    it('should allow retrieving the image metadata of a GIF', () => expect('GET /animated.gif?metadata', 'to yield response', {
      body: {
        format: 'gif',
    ...
    it('should allow retrieving the image metadata of a JPEG converted to GIF', () => expect(
    ...
    it('should allow retrieving the image metadata for the result of an operation', () => expect(
    ...
    it('should include the EXIF data in the image metadata', () => expect('GET /exifOriented.jpg?metadata', 'to yield response', {
      body: {
        image: {
          Make: 'Apple',
          Model: 'iPhone 6'
    ...
    it('should include orientedWidth and orientedHeight properties when the EXIF data specifies an orientation', () => expect('GET /exifOriented.jpg?metadata', 'to yield response', {
      body: {
        width: 3264,
        height: 2448,
        orientedWidth: 2448,
    ...
    it('should auto-orient an image', () => expect('GET /exifOriented.jpg?rotate', 'to yield response', {
      body: expect.it('to have metadata satisfying', {
        size: {
          width: 2448,
          height: 3264
    ...
    it('should parse the ICC Profile data if available', () => expect('GET /Landscape_8.jpg?metadata', 'to yield response', {
      body: {
        icc: {
          deviceClass: 'Monitor',
          colorSpace: 'RGB'
    ...
    it('should send back the upstream Content-Type and Content-Length when ?metadata is applied to a non-image with an image extension', () => expect(
    ...
    it('should send back an error when an operation is applied to a non-image', () => expect(
      'GET /certainlynotanimage.jpg?resize=10,10',
      'to yield response',
      415
    ));

    it('should allow a crop operation with the gravity specified as a string', () => expect(
    ...
    it('should fix the ordering of the parameters to extract to be left,top,width,height', () => expect(
    ...
    it('should propagate a "bad extract area" error correctly', () => expect(
    ...
    it('should convert an animated gif to png', () => expect('GET /animated.gif?png', 'to yield response', {
      body: expect.it('to have metadata satisfying', {
        format: 'PNG',
        size: {
          width: 23,
    ...
    it('should ignore invalid operations', () => expect('GET /turtle.jpg?resize=10%22', 'to yield response', {
      body: expect.it('to have metadata satisfying', {
        size: {
          width: 481,
          height: 424
  ...
  it('should process a big image when the compression middleware is present above express-processimage', () => expect(
    express()
  ...
  it('should work fine when cropping an item starting from top 0 and left 0', () => expect('GET /turtle.jpg?extract=0,0,300,200', 'to yield response', {
    body: expect.it(
      'to resemble',
      pathModule.resolve(
        __dirname,
  ...
  describe('with the gm engine', () => {
    it('should allow a crop operation with a gravity of center', () => expect(
    ...
    it('should allow a crop operation with a gravity of northeast', () => expect(
    ...
    describe('when omitting the height', () => {
      it('should do a proportional resize to the given width', () => expect('GET /turtle.jpg?gm&resize=500,', 'to yield response', {
        body: expect.it('to have metadata satisfying', {
          size: {
            width: 500,
            height: 441
    ...
    describe('when omitting the width', () => {
      it('should do a proportional resize to the given height', () => expect('GET /turtle.jpg?gm&resize=,500', 'to yield response', {
        body: expect.it('to have metadata satisfying', {
          size: {
            width: 567,
            height: 500
    ...
    [true, false].forEach(gifsicleAvailable => {
      describe(
        ...
        () => {
          ...
          it('should resize an animated gif', () => expect(
          ...
          it('should support the withoutEnlargement modfier', () => expect(
          ...
          it('should support the ignoreAspectRatio modfier', () => expect(
          ...
          it('should support resize with crop', () => expect(
          ...
          it('should resize a non-animated gif', () => expect('GET /bulb.gif?resize=200,200', 'to yield response', {
            headers: {
          ...
          it('should resize an animated gif with differently sized frames', () => expect('GET /cat.gif?resize=200,200', 'to yield response', {
            headers: {
              'X-Express-Processimage': gifsicleAvailable ? 'gifsicle' : 'gm'
            },
            body: expect.it('to have metadata satisfying', {
          ...
          it('should support extract and rotate', () => expect(
          ...
          it('should support rotate with a single argument', () => expect('GET /bulb.gif?rotate=90', 'to yield response', {
            headers: {
              'X-Express-Processimage': gifsicleAvailable ? 'gifsicle' : 'gm'
            },
            body: expect
          ...
          it('should support generating a progressive (interlaced) GIF', () => expect(
          ...
          describe('when omitting the width', () => {
            it('should do a proportional resize to the given height', () => expect('GET /bulb.gif?resize=20,', 'to yield response', {
              body: expect.it('to have metadata satisfying', {
                size: {
                  width: 20,
                  height: 20
          ...
          describe('when omitting the height', () => {
            it('should do a proportional resize to the given width', () => expect('GET /bulb.gif?resize=,25', 'to yield response', {
              body: expect.it('to have metadata satisfying', {
                size: {
                  width: 25,
                  height: 25
  ...
  it('should handle resize before extract', () => expect(
  ...
  describe('with invalid parameters', () => {
    [
      ...
      it('disallows an operation of ' + invalidOperation, () => expect(
    ...
    it('should not break when there is only a "modifier" filter left after the invalid operations have been trimmed', () => expect(
  ...
  it('should discard If-None-Match tokens that do not have a -processimage suffix', () => expect(
    express()
      .use(processImage(config))
      .use((req, res, next) => {
  ...
  it('should strip the suffix from If-None-Match tokens that do have a -processimage suffix', () => expect(
    express()
      .use(processImage(config))
      .use((req, res, next) => {
        expect(
  ...
  it('should run resize .ico file with gm module by converting image from .ico to .png format', () => expect('GET /favicon.ico?gm&png&resize=10,10', 'to yield response', {
    statusCode: 200,
    headers: {
      'Content-Type': 'image/png'
    },
