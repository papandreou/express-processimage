...
describe('browser-sync compatibility', () => {
  ...
  it('should not mess with request for non-image file', () => expect(
  ...
  it('should not mess with request for image with no query string', () => expect(
  ...
  it('should not mess with request for image with an unsupported operation in the query string', () => expect(
  ...
  it('should return a 304 status code when requesting the same image with unchanged modifications', () => expect(
    `GET http://localhost:${serverPort}/ancillaryChunks.png?foo=bar`,
    'to yield response',
    {
      statusCode: 200,
